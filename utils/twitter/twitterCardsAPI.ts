...
// Function name is 'hyper-worker' (corresponds to URL in Dashboard)
const SUPABASE_FUNCTION_URL = import.meta.env.VITE_SUPABASE_FUNCTION_URL || `${getApiUrl()}/hyper-worker`;

import type { TwitterCardMapping } from '../../src/types/social';
