...
import GiftCardABI from './abis/GiftCard.json';
import amazonImg from './public/assets/amazon.jpg';
import appleImg from './public/assets/apple.jpg';
import airbnbImg from './public/assets/airbnb.jpg';
import sendlyLogo from './public/svg/sendly_logo.svg';
import baseWordmark from './public/svg/Base_Wordmark_Blue.svg';
import giftBoxLogo from './public/assets/download2.png';
import { useAccount } from 'wagmi';
import { Name, Avatar } from '@coinbase/onchainkit/identity';
import { base } from 'wagmi/chains';
import { SmartWalletConnect } from "./SmartWalletConnect";
import { usePaymaster } from './components/PaymasterProvider';
import ERC20ABI from './abis/ERC20.json';
import { giftCard_Pink } from './public/svg/giftCard_Pink.js';
import { giftCard_Blue } from './public/svg/giftCard_Blue.js';
import { giftCard_Green } from './public/svg/giftCard_Green.js';
...
function App() {
  ...
  const services = [
    { name: 'Amazon', img: amazonImg },
    { name: 'Apple', img: appleImg },
    { name: 'Airbnb', img: airbnbImg },
  ];
